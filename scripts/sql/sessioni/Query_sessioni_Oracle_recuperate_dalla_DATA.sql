-- Source: https://www.scriptdba.com/query-per-vedere-le-sessioni-per-data/
-- Title: Query sessioni Oracle recuperate dalla DATA
...
s.sql_id, s.process,s.program, s.schemaname,
...
and to_char(s.logon_time,'DD-MM-YY HH24:MI') < '&data';
