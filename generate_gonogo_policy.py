...
output_path = r"c:\DBA\dba_oracle_lab\docs\04_governance_learning\02_enterprise_standards\GO_NO_GO_MASTER_MERGE_POLICY.md"

content = """# RUNBOOK ENTERPRISE: CI/CD GITOPS DATABASE DEPLOYMENT & GO/NO-GO POLICY
...
print(f"Created Go/No-Go Policy at {output_path}")
 f.write(content)
 f.write(content)
