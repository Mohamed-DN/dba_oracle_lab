...
output_path = r"c:\DBA\dba_oracle_lab\docs\04_governance_learning\02_enterprise_standards\RELIABILITY_FRAMEWORK.md"

content = """# RUNBOOK ENTERPRISE: SITE RELIABILITY ENGINEERING (SRE) FOR ORACLE DATABASE
...
- **Come evitiamo che riaccada?** (Azioni correttive tracciabili e assegnate).
...
print(f"Created Reliability Framework at {output_path}")
"""
