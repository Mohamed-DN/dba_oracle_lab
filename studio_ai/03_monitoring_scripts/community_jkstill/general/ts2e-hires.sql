...
prompt
prompt Example: @ts2e-hires '19-DEC-16 04.02.10.838000000 PM' 'US/Eastern'



col u_timestamp new_value u_timestamp noprint
col u_tz new_value u_tz noprint
col epoch_hires  format  999999999999999999999999 new_value v_epoch_hires
...
select 
	((days*86400) + (hours * 60 * 60) + (minutes * 60) + seconds) * 1000000 epoch_hires
from utc_components
/
