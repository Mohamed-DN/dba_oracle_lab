...
- SCAN Name: `rac-scan.oracleland.local`  
- SCAN Port: `1521`
...
- Aggiungi `rac2` cliccando "Add":
  - Public Hostname: `rac2.oracleland.local`
  - Virtual Hostname: `rac2-vip.oracleland.local`
- `rac1` sarà già presente:
  - Virtual Hostname: `rac1-vip.oracleland.local`
