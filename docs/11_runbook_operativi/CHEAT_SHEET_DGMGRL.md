...
- Guida estesa: [GUIDA_FASE4_DATAGUARD_DGMGRL](../02_high_availability/GUIDA_FASE4_DATAGUARD_DGMGRL.md)
- Guida operativa: [GUIDA_SWITCHOVER_COMPLETO](../02_high_availability/GUIDA_SWITCHOVER_COMPLETO.md)
