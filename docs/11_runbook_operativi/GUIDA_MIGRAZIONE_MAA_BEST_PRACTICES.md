...
Usa il tool `oggca.sh` per generare le Web UI su specifiche porte. (Segui la [Fase 7 aggiornata](../07_replication/GUIDA_FASE7_GOLDENGATE.md)).
...
Segui la [Fase 7 aggiornata](../07_replication/GUIDA_FASE7_GOLDENGATE.md) per i dettagli operativi per implementare questo workflow.
