...
ADMINISTER KEY MANAGEMENT CREATE KEYSTORE '/u01/app/oracle/admin/wallet/PRDDB' IDENTIFIED BY "WalletPass_2026!";
ADMINISTER KEY MANAGEMENT SET KEYSTORE OPEN IDENTIFIED BY "WalletPass_2026!";
ADMINISTER KEY MANAGEMENT SET KEY IDENTIFIED BY "WalletPass_2026!" WITH BACKUP;

-- Creare l'Auto-Login Wallet (fondamentale affinché il DB possa aprirsi automaticamente ai riavvii)
ADMINISTER KEY MANAGEMENT CREATE AUTO_LOGIN KEYSTORE FROM KEYSTORE '/u01/app/oracle/admin/wallet/PRDDB' IDENTIFIED BY "WalletPass_2026!";
```
