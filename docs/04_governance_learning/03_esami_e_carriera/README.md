...
| [Attività DBA](./GUIDA_ATTIVITA_DBA.md) | Task operativi quotidiani |
| [Preparazione Attività Lab RAC](./GUIDA_ATTIVITA_LAB_RAC.md) | Responsabilità operative e mindset |
| [Validazione Best Practices](./VALIDAZIONE_BEST_PRACTICES.md) | Audit e scorecard |
...
- [GUIDA_PDB_DATAGUARD_SERVICES.md](../../02_core_dba/04_high_availability_and_rac/GUIDA_PDB_DATAGUARD_SERVICES.md)
