...
> **Nota**: AWR richiede la licenza **Diagnostic Pack** (inclusa in Enterprise Edition). Nel lab non c'è problema. In produzione, verifica la tua licenza.
...
> **Prossimo**: [GUIDA_MAA_BEST_PRACTICES.md](../../02_core_dba/04_high_availability_and_rac/GUIDA_MAA_BEST_PRACTICES.md) — Validazione del lab contro Oracle MAA
