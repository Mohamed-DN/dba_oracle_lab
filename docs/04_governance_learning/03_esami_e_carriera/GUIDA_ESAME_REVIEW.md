...
> 📖 Riferimento Lab: [GUIDA_ARCHITETTURA_ORACLE.md](../../04_governance_learning/01_fondamenti_teorici/GUIDA_ARCHITETTURA_ORACLE.md)
...
> 📖 Riferimento Lab: [GUIDA_COMANDI_DBA.md](../../04_governance_learning/01_fondamenti_teorici/GUIDA_COMANDI_DBA.md)
...
> 📖 Riferimento Lab: [GUIDA_LISTENER_SERVICES_DBA.md](../../02_core_dba/01_administration_and_security/GUIDA_LISTENER_SERVICES_DBA.md)
...
> Nel nostro lab usiamo **ASMLib (`oracleasm`)** per la gestione dei dischi, vedi [Fase 0](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE0_SETUP_MACCHINE.md) e [Fase 2](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md).

### 11.2 High Availability: RAC e Data Guard

> 📖 Riferimento Lab: [Fase 2](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md), [Fase 3](../../02_core_dba/04_high_availability_and_rac/GUIDA_FASE3_RAC_STANDBY.md), [Fase 4](../../02_core_dba/04_high_availability_and_rac/GUIDA_FASE4_DATAGUARD_DGMGRL.md)
...
> 📖 Riferimento Lab: [GUIDA_FASE5_RMAN_BACKUP.md](../../02_core_dba/02_backup_and_recovery/GUIDA_FASE5_RMAN_BACKUP.md)
...
> 📖 Riferimento Lab: [Fase 2 — sezione 2.8](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md)
...
# Data Recovery Advisor (DRA): sintassi legacy deprecata in 19c,
# da conoscere ma non usare come runbook operativo.
RMAN> LIST FAILURE;
RMAN> ADVISE FAILURE;
RMAN> REPAIR FAILURE;
...
> 📖 Riferimento Lab: [Fase 0](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE0_SETUP_MACCHINE.md), [Fase 2 — sez. 2.8](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md)
...
|---|---|
| DB Architecture | [GUIDA_ARCHITETTURA_ORACLE.md](../../04_governance_learning/01_fondamenti_teorici/GUIDA_ARCHITETTURA_ORACLE.md) |
| Instance Management | [GUIDA_COMANDI_DBA.md](../../04_governance_learning/01_fondamenti_teorici/GUIDA_COMANDI_DBA.md) |
| Users/Roles/Privileges | [GUIDA_CDB_PDB_UTENTI.md](../../02_core_dba/01_administration_and_security/GUIDA_CDB_PDB_UTENTI.md) |
...
| Net Services / Listener | [GUIDA_LISTENER_SERVICES_DBA.md](../../02_core_dba/01_administration_and_security/GUIDA_LISTENER_SERVICES_DBA.md) |
...
| Argomento Esame | Dove lo Pratichi nel Lab |
|---|---|
| ASM | [Fase 0](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE0_SETUP_MACCHINE.md) + [Fase 2](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md) |
| RAC (High Availability) | [Fase 2](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md) |
| Data Guard | [Fase 3](../../02_core_dba/04_high_availability_and_rac/GUIDA_FASE3_RAC_STANDBY.md) + [Fase 4](../../02_core_dba/04_high_availability_and_rac/GUIDA_FASE4_DATAGUARD_DGMGRL.md) |
| Switchover/Failover | [GUIDA_SWITCHOVER](../../02_core_dba/04_high_availability_and_rac/GUIDA_SWITCHOVER_COMPLETO.md) + [GUIDA_FAILOVER](../../02_core_dba/04_high_availability_and_rac/GUIDA_FAILOVER_E_REINSTATE.md) |
| Multitenant (CDB/PDB) | [GUIDA_CDB_PDB_UTENTI.md](../../02_core_dba/01_administration_and_security/GUIDA_CDB_PDB_UTENTI.md) + Sezione 11.8 |
| RMAN Backup/Recovery | [GUIDA_FASE5_RMAN_BACKUP.md](../../02_core_dba/02_backup_and_recovery/GUIDA_FASE5_RMAN_BACKUP.md) + Sezione 11.9 |
| Flashback Technologies | Sezione 11.9.3 |
| Deploy/Patch/Upgrade | [Fase 2 — sez. 2.8](../../03_infra_lab/02_oracle_installation_asm/GUIDA_FASE2_GRID_E_RAC.md) + Sezione 11.10 |
...
| Security (TDE, Audit) | [GUIDA_CDB_PDB_UTENTI.md](../../02_core_dba/01_administration_and_security/GUIDA_CDB_PDB_UTENTI.md) + Sezione 11.6 |
| GoldenGate | [Fase 7](../../02_core_dba/07_replication_goldengate/GUIDA_FASE7_GOLDENGATE.md) |
| Oracle→PostgreSQL | [GUIDA_MIGRAZIONE_PG](../../02_core_dba/07_replication_goldengate/GUIDA_MIGRAZIONE_ORACLE_POSTGRES.md) |

---

> → **Prossimo**: [GUIDA_MIGRAZIONE_ORACLE_POSTGRES.md](../../02_core_dba/07_replication_goldengate/GUIDA_MIGRAZIONE_ORACLE_POSTGRES.md) — Migrazione Oracle → PostgreSQL con GoldenGate
