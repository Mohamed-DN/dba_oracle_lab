...
| esempio crontab | `crontab_shams_example` |
| `cfg/rman_backup_<DB_UNIQUE_NAME>.conf` | `cfg/rman_backup_M24SHAMSPEC.conf.example` e `cfg/rman_backup_M24SHAMSSEC.conf.example` |
