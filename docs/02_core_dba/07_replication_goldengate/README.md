...
| 6 | [Runbook End-to-End 19c](./GUIDA_GOLDENGATE_RUNBOOK_END_TO_END_19C.md) | Procedura completa da zero: assessment, grant, Extract, trail, Replicat, heartbeat, cutover |
...
| 14 | [Upgrade 19c -> 26ai](./GUIDA_GOLDENGATE_UPGRADE_19C_TO_26AI.md) | Upgrade Microservices, percorso Classic, backup, rollback, validazioni |
...
| [Runbook End-to-End 19c](./GUIDA_GOLDENGATE_RUNBOOK_END_TO_END_19C.md) | Procedura operativa completa per implementare i use case |
