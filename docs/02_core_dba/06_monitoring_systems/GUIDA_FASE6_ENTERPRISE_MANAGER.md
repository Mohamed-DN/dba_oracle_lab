...
**← [FASE 5: RMAN Backup](../../02_core_dba/02_backup_and_recovery/GUIDA_FASE5_RMAN_BACKUP.md)** | 📍 [Indice Percorso Lab](../../04_governance_learning/03_esami_e_carriera/README.md) | **→ [FASE 7: GoldenGate](../../02_core_dba/07_replication_goldengate/GUIDA_FASE7_GOLDENGATE.md)**
