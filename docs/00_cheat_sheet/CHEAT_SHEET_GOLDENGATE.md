...
- Guida lab: [GUIDA_FASE7_GOLDENGATE](../07_replication/GUIDA_FASE7_GOLDENGATE.md)
- Migrazione: [GUIDA_MIGRAZIONE_GOLDENGATE](../07_replication/GUIDA_MIGRAZIONE_GOLDENGATE.md)
- Test template: [TESTLOG_GOLDENGATE_TEMPLATE](../07_replication/TESTLOG_GOLDENGATE_TEMPLATE.md)
