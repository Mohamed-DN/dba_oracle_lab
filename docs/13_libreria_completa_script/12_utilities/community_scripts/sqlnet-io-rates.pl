...
=head1 sqlnet-io-rates.pl
 ...
 =====  ===  =========== =========== ==================   =================   ========================
  ...
  example:
    ...
    ./sqlnet-io-rates.pl  -database oraserver/orcl.jks.com -username scott -password <password> -interval-seconds 60 -iterations 7200
...
usage: $basename
  ...
  $basename  -database oraserver\/orcl.abc.com -username scott -password <password> -interval-seconds 60 -iterations 7200
