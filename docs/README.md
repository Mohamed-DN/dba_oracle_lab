...
| [`02_core_dba/07_replication_goldengate`](./02_core_dba/07_replication_goldengate/) | GoldenGate 19c completo: ambienti critici, collegamento source/target, Microservices, Classic/GGSCI, Oracle->PostgreSQL, topologie, Knowledge Hub, 26ai e upgrade. |
