...
|---|---|
| [`01_operations/01_cheat_sheets`](./01_operations/01_cheat_sheets/) | Cheat sheet a colpo d'occhio: Oracle Tools Command Center, SRVCTL, CRSCTL, ASMCMD, ADRCI, RMAN, DGMGRL, LSNRCTL, OPatch, SQLPlus, GoldenGate. |
...
| [`02_core_dba/08_zero_downtime_migration`](./02_core_dba/08_zero_downtime_migration/) | **Zero Downtime Migration (ZDM)**: procedure operative e runbook architetturali per migrazioni cloud-native Offline/Online. |
