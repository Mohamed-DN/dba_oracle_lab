...
> 1. **Check Metriche ASM**: `@../../01_operations/04_libreria_script_completa/01_asm_storage/community_scripts/asm-diskgroup-stat.sql`
> 2. **Analisi Spazio Oggetti**: `@../../01_operations/04_libreria_script_completa/12_utilities/community_scripts/storage/showspace.sql`
...
Esegui lo script:
```sql
@../../01_operations/04_libreria_script_completa/01_asm_storage/asm_limits_ausize.sql
```
...
Esegui lo script:
```sql
@../../01_operations/04_libreria_script_completa/12_utilities/community_scripts/storage/tbs_maxsize_limits.sql
```
...
Esegui:
```sql
@../../01_operations/04_libreria_script_completa/12_utilities/community_scripts/storage/gen_bigfile_autoextend.sql
```
