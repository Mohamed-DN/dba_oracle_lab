...
|---|---:|
| `asm_storage` (ASM & Storage) | 26 |
| `dataguard` (Data Guard) | 0 |
| `monitoring_scripts` (Monitoring) | 560 |
| `user_management` (User Management) | 5 |
| `patching` (Patching) | 2 |
| `backup_recovery` (Backup & Recovery) | 12 |
| `performance_tuning` (Performance Tuning) | 230 |
| `tde_security` (TDE & Security) | 8 |
| `compression` (Compression) | 1 |
| `partition_manager` (Partition Manager) | 2 |
| `sql_templates` (SQL Templates) | 17 |
| `utilities` (Utilities) | 102 |

## Dettaglio script per script

### `asm_storage` — ASM & Storage (26 script)
...
### `monitoring_scripts` — Monitoring (560 script)

| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`Gestione code oracle per NIX.sql`](./monitoring_scripts/%20Gestione%20code%20oracle%20per%20NIX.sql) | `-` | MEDIO | OK | grant da dare anche all'utente OWNER delle queue tables per corretto funzionamento |
| [`___ Situation.sql`](./monitoring_scripts/___%20Situation.sql) | `-` | ALTO | OK | ACTIVE SESSIONS |
| [`ActiveSessionHistoryQueries.sql`](./monitoring_scripts/ActiveSessionHistoryQueries.sql) | `-` | BASSO | OK | Script operativo Oracle per: ActiveSessionHistoryQueries. |
| [`ASH.sql`](./monitoring_scripts/ASH.sql) | `-` | MEDIO | OK | https://blogs.oracle.com/oraclemagazine/beginning-performance-tuning-active-session-history |
| [`AshTopProcedure.sql`](./monitoring_scripts/AshTopProcedure.sql) | `-` | BASSO | OK | Analisi Active Session History (ASH) per colli di bottiglia e top consumer. |
...
| [`locks.sql`](./monitoring_scripts/locks.sql) | `-` | BASSO | OK | locks.sql locks and enqueue blocks for 11g |
| [`locks_10g.sql`](./monitoring_scripts/locks_10g.sql) | `-` | BASSO | OK | in 11g can use select .. from v$wait_chains |
| [`locks_blocking.sql`](./monitoring_scripts/locks_blocking.sql) | `-` | BASSO | OK | | Jeffrey M. Hunter | |
| [`locks_details.sql`](./monitoring_scripts/locks_details.sql) | `-` | BASSO | OK | locks.sql locks and enqueue blocks for 11g |
| [`PGA.sql`](./monitoring_scripts/PGA.sql) | `-` | BASSO | OK | Limiting process size with database parameter PGA_AGGREGATE_LIMIT (Doc ID 1520324.1) |
| [`Processi.sql`](./monitoring_scripts/Processi.sql) | `-` | MEDIO | OK | OSPID FROM SID |
| [`Stats_workflow.sql`](./monitoring_scripts/Stats_workflow.sql) | `-` | MEDIO | OK | Check Autotask job history |
| [`sysaux_fix.sql`](./monitoring_scripts/sysaux_fix.sql) | `-` | ALTO | OK | WRI$_OPTSTAT_HISTGRM_HISTORY non può essere shrinkata... dovrebbe contenere 1 mese di dati |
| [`View_Blocking.sql`](./monitoring_scripts/View_Blocking.sql) | `-` | BASSO | OK | Mostra le sessioni bloccanti |
| [`View_Cpu_Consumer.sql`](./monitoring_scripts/View_Cpu_Consumer.sql) | `-` | ALTO | OK | Script operativo Oracle per: View Cpu Consumer. |
| [`View_Cpu_Hist.sql`](./monitoring_scripts/View_Cpu_Hist.sql) | `-` | MEDIO | OK | `round((round((nw.value - ol.value) / 100)) / ((cast(nw.end_interval_time as date) - cast(ol.end_interval_time as date)) * 24 *60 * 60),2)` us |
| [`View_IO_Database.sql`](./monitoring_scripts/View_IO_Database.sql) | `-` | BASSO | OK | Total|Small|IOPS" questa colonna quella da considerare per calcolare il numero di I/O al secondo fatti dal database |
| [`View_IO_Hist.sql`](./monitoring_scripts/View_IO_Hist.sql) | `-` | BASSO | OK | 'control file parallel write', |
| [`View_IO_RealTime.sql`](./monitoring_scripts/View_IO_RealTime.sql) | `-` | BASSO | OK | 'control file parallel write' |
| [`View_RedoGeneration.sql`](./monitoring_scripts/View_RedoGeneration.sql) | `-` | ALTO | OK | Shows current redo logs generation info (RAC-non RAC environment) |
| [`ViewSession.sql`](./monitoring_scripts/ViewSession.sql) | `-` | MEDIO | OK | wait.p1text||' = '||wait.p1 p1, |

### `user_management` — User Management (5 script)

| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`GeneraPass_Random_da_Bash.txt`](./user_management/GeneraPass_Random_da_Bash.txt) | `-` | BASSO | OK | Solo caratteri -- Esempio: TPBahbBuHLqL |
| [`Prototipo_CreateUser_DB_APPLICATIVA_v1.3.txt`](./user_management/Prototipo_CreateUser_DB_APPLICATIVA_v1.3.txt) | `-` | MEDIO | OK | Fare la replace di xxx con UTENTE per generare uno script secondo standard |
| [`Prototipo_CreateUser_DBA_OP_v1.3.txt`](./user_management/Prototipo_CreateUser_DBA_OP_v1.3.txt) | `-` | MEDIO | OK | CREAZIONE UTENTE DBA_OP nel caso in cui non esista |
| [`Prototipo_CreateUser_Nominale_v1.4.txt`](./user_management/Prototipo_CreateUser_Nominale_v1.4.txt) | `-` | MEDIO | OK | Le utenze nominali hanno il formato COxxxx per esterni e D0xxxx per gli interni e vengono comunicati da Security Governance |
| [`Verify Function PWD.txt`](./user_management/Verify%20Function%20PWD.txt) | `-` | MEDIO | OK | Check if the password is same as the username |

### `patching` — Patching (2 script)

| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`golden_images_ohctl.txt`](./patching/golden_images_ohctl.txt) | `-` | MEDIO | OK | define colors for bash candiness |
| [`setoh.txt`](./patching/setoh.txt) | `-` | BASSO | OK | ic is a shortcut for the Instant Client |

### `backup_recovery` — Backup & Recovery (12 script)
...
### `performance_tuning` — Performance Tuning (230 script)
...
| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`Get_DDL_RENAME_OBJECT_v1.3.sql`](./compression/Get_DDL_RENAME_OBJECT_v1.3.sql) | `-` | ALTO | OK | Dare i privilegi allo schema proprietario della funzione |

### `partition_manager` — Partition Manager (2 script)

| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`dba_op_user_setup.sql`](./partition_manager/dba_op_user_setup.sql) | `-` | ALTO | OK | default tablespace for DBA_OP |
| [`Script_Creazione_Partition_Manager_v2_36.sql`](./partition_manager/Script_Creazione_Partition_Manager_v2_36.sql) | `-` | ALTO | OK | Script per Creazione Package Svecchiamento Tabelle |

### `sql_templates` — SQL Templates (17 script)

| Script | Sottocartella | Rischio | Stato cartella | Spiegazione |
|---|---|---|---|---|
| [`00X_Form_alter_index.sql`](./sql_templates/00X_Form_alter_index.sql) | `-` | MEDIO | OK | Script operativo Oracle per: 00X Form alter index. |
| [`00X_Form_alter_table.sql`](./sql_templates/00X_Form_alter_table.sql) | `-` | MEDIO | OK | Script operativo Oracle per: 00X Form alter table. |
| [`00X_Form_assign_grant.sql`](./sql_templates/00X_Form_assign_grant.sql) | `-` | MEDIO | OK | Script operativo Oracle per: 00X Form assign grant. |
| [`00X_Form_create_index.sql`](./sql_templates/00X_Form_create_index.sql) | `-` | MEDIO | OK | CREATE INDEX |
| [`00X_Form_create_table.sql`](./sql_templates/00X_Form_create_table.sql) | `-` | MEDIO | OK | CREATE TABLE |
| [`00X_Form_create_view.sql`](./sql_templates/00X_Form_create_view.sql) | `-` | MEDIO | OK | Script operativo Oracle per: 00X Form create view. |
| [`00X_Form_dml.sql`](./sql_templates/00X_Form_dml.sql) | `-` | ALTO | OK | Script operativo Oracle per: 00X Form dml. |
| [`00X_Form_drop_table.sql`](./sql_templates/00X_Form_drop_table.sql) | `-` | ALTO | OK | Script operativo Oracle per: 00X Form drop table. |
| [`00X_Form_foreign_key.sql`](./sql_templates/00X_Form_foreign_key.sql) | `-` | MEDIO | OK | CREATE FOREIGN KEY |
| [`00X_Form_loop_commit.sql`](./sql_templates/00X_Form_loop_commit.sql) | `-` | BASSO | OK | PL/SQL WITH PARTIAL COMMIT |
| [`00X_Form_package.sql`](./sql_templates/00X_Form_package.sql) | `-` | MEDIO | OK | CREATE PACKAGE |
| [`00X_Form_primary_key.sql`](./sql_templates/00X_Form_primary_key.sql) | `-` | MEDIO | OK | CREATE PRIMARY KEY |
| [`00X_Form_procedure.sql`](./sql_templates/00X_Form_procedure.sql) | `-` | MEDIO | OK | CREATE PROCEDURE |
| [`00X_Form_sequence.sql`](./sql_templates/00X_Form_sequence.sql) | `-` | MEDIO | OK | CREATE SEQUENCE |
| [`00X_Form_sinonimi.sql`](./sql_templates/00X_Form_sinonimi.sql) | `-` | MEDIO | OK | CREATE SYNONYM |
| [`00X_Form_trigger.sql`](./sql_templates/00X_Form_trigger.sql) | `-` | MEDIO | OK | CREATE TRIGGER |
| [`Form_loop_rowid.sql`](./sql_templates/Form_loop_rowid.sql) | `-` | ALTO | OK | creazione tabella rowid |

### `utilities` — Utilities (102 script)
...
| [`pdb-awr-enable.sql`](./utilities/cdb_pdb/pdb-awr-enable.sql) | `community_scripts/cdb_pdb` | ALTO | OK | pdb-awr-enable.sql |
| [`pdb-modifiable-params-dump.sql`](./utilities/cdb_pdb/pdb-modifiable-params-dump.sql) | `community_scripts/cdb_pdb` | BASSO | OK | pdb-modifiable-params-dump.sql |
| [`pdb-violations.sql`](./utilities/cdb_pdb/pdb-violations.sql) | `community_scripts/cdb_pdb` | BASSO | OK | pdb-violations.sql |
...
| [`autotask_auto_stats_disable.sql`](./utilities/scheduler/autotask_auto_stats_disable.sql) | `community_scripts/scheduler` | BASSO | OK | disable automatics tasks |
| [`autotask_auto_stats_enable.sql`](./utilities/scheduler/autotask_auto_stats_enable.sql) | `community_scripts/scheduler` | BASSO | OK | enable automatics stats |
| [`autotask_auto_tasks_disable.sql`](./utilities/scheduler/autotask_auto_tasks_disable.sql) | `community_scripts/scheduler` | BASSO | OK | disable automatics tasks |
| [`autotask_auto_tasks_enable.sql`](./utilities/scheduler/autotask_auto_tasks_enable.sql) | `community_scripts/scheduler` | BASSO | OK | enable automatics stats |
| [`autotask_client_attributes.sql`](./utilities/scheduler/autotask_client_attributes.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask client attributes. |
| [`autotask_client_history.sql`](./utilities/scheduler/autotask_client_history.sql) | `community_scripts/scheduler` | BASSO | OK | WHERE client_name like '%stats%' |
| [`autotask_client_job.sql`](./utilities/scheduler/autotask_client_job.sql) | `community_scripts/scheduler` | BASSO | OK | where client_name='auto optimizer stats collection' |
| [`autotask_clients.sql`](./utilities/scheduler/autotask_clients.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask clients. |
| [`autotask_job_history.sql`](./utilities/scheduler/autotask_job_history.sql) | `community_scripts/scheduler` | BASSO | OK | where client_name like '%optimizer stats%' |
| [`autotask_operation.sql`](./utilities/scheduler/autotask_operation.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask operation. |
| [`autotask_resources.sql`](./utilities/scheduler/autotask_resources.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask resources. |
| [`autotask_sched.sql`](./utilities/scheduler/autotask_sched.sql) | `community_scripts/scheduler` | BASSO | OK | , start_time |
| [`autotask_sql_setup.sql`](./utilities/scheduler/autotask_sql_setup.sql) | `community_scripts/scheduler` | BASSO | OK | set nls_timezone_tz_format to 'yyyy-mm-dd hh24:mi:ss tzh:tzm' |
| [`autotask_task.sql`](./utilities/scheduler/autotask_task.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask task. |
| [`autotask_window_clients.sql`](./utilities/scheduler/autotask_window_clients.sql) | `community_scripts/scheduler` | BASSO | OK | , health_monitor |
| [`autotask_window_hist.sql`](./utilities/scheduler/autotask_window_hist.sql) | `community_scripts/scheduler` | BASSO | OK | Script operativo Oracle per: autotask window hist. |
| [`cdb_sched_jobs.sql`](./utilities/scheduler/cdb_sched_jobs.sql) | `community_scripts/scheduler` | BASSO | OK | dba_scheduler_jobs.sql |
| [`dba_jobs.sql`](./utilities/scheduler/dba_jobs.sql) | `community_scripts/scheduler` | BASSO | OK | Diagnostica e controllo job Oracle Scheduler. |
| [`dba_jobs_running.sql`](./utilities/scheduler/dba_jobs_running.sql) | `community_scripts/scheduler` | BASSO | OK | Diagnostica e controllo job Oracle Scheduler. |
| [`dba_sched_jobs.sql`](./utilities/scheduler/dba_sched_jobs.sql) | `community_scripts/scheduler` | BASSO | OK | dba_scheduler_jobs.sql |
| [`dba_sched_jobs_hist.sql`](./utilities/scheduler/dba_sched_jobs_hist.sql) | `community_scripts/scheduler` | BASSO | OK | jkstill@gmail.com |
| [`disable-autotasks-resource-mgr.sql`](./utilities/scheduler/disable-autotasks-resource-mgr.sql) | `community_scripts/scheduler` | ALTO | OK | Oracle sometimes enforces Resource Manager for background processes |
| [`get_stats_job.sql`](./utilities/scheduler/get_stats_job.sql) | `community_scripts/scheduler` | BASSO | OK | Diagnostica e controllo job Oracle Scheduler. |
| [`job_submit.sql`](./utilities/scheduler/job_submit.sql) | `community_scripts/scheduler` | BASSO | OK | job_submit.sql |
| [`scheduler_programs.sql`](./utilities/scheduler/scheduler_programs.sql) | `community_scripts/scheduler` | BASSO | OK | Diagnostica e controllo job Oracle Scheduler. |
| [`scheduler_windows.sql`](./utilities/scheduler/scheduler_windows.sql) | `community_scripts/scheduler` | BASSO | OK | , next_start_date |
| [`show_jobs.sql`](./utilities/scheduler/show_jobs.sql) | `community_scripts/scheduler` | BASSO | OK | current_session_label, |
...
| [`dfshrink-gen.sql`](./utilities/storage/dfshrink-gen.sql) | `community_scripts/storage` | ALTO | OK | dfshrink-gen.sql |
| [`gen_bigfile_autoextend.sql`](./utilities/storage/gen_bigfile_autoextend.sql) | `community_scripts/storage` | MEDIO | OK | Generatore di comandi per estendere MAXSIZE sui BIGFILE Tablespaces |
| [`maxext3.sql`](./utilities/storage/maxext3.sql) | `community_scripts/storage` | BASSO | OK | find tables/indexes with only 1 or 2 extents to go before |
| [`showdf.sql`](./utilities/storage/showdf.sql) | `community_scripts/storage` | BASSO | OK | get from dba_data_files and dba_temp_files rather that v$ views |
| [`showdf7.sql`](./utilities/storage/showdf7.sql) | `community_scripts/storage` | BASSO | OK | Script operativo Oracle per: showdf7. |
| [`showdf8i.sql`](./utilities/storage/showdf8i.sql) | `community_scripts/storage` | BASSO | OK | showdf8i.sql |
| [`showfree.sql`](./utilities/storage/showfree.sql) | `community_scripts/storage` | BASSO | OK | showfree.sql |
| [`showfreemax.sql`](./utilities/storage/showfreemax.sql) | `community_scripts/storage` | BASSO | OK | showmaxfree.sql |
| [`showfreesum.sql`](./utilities/storage/showfreesum.sql) | `community_scripts/storage` | BASSO | OK | showfreesum.sql |
| [`showspace.sql`](./utilities/storage/showspace.sql) | `community_scripts/storage` | BASSO | OK | showspace.sql |
| [`showtbs.sql`](./utilities/storage/showtbs.sql) | `community_scripts/storage` | BASSO | OK | spool tbs.lis |
| [`tbs_maxsize_limits.sql`](./utilities/storage/tbs_maxsize_limits.sql) | `community_scripts/storage` | BASSO | OK | MAXSIZE vs ACTUAL SIZE (Non-CDB/CDB Tablespaces) |
| [`undo_blocks_required.sql`](./utilities/storage/undo_blocks_required.sql) | `community_scripts/storage` | BASSO | OK | undo_blocks_required.sql |
| [`undo_retention_available.sql`](./utilities/storage/undo_retention_available.sql) | `community_scripts/storage` | BASSO | OK | undo_retention_available.sql |
| [`undo_stats.sql`](./utilities/storage/undo_stats.sql) | `community_scripts/storage` | BASSO | OK | undo_stats.sql |
| [`Install_pkg_Dba_Utility_20220713_v1_9_PROD.sql`](./utilities/Install_pkg_Dba_Utility_20220713_v1_9_PROD.sql) | `-` | ALTO | OK | Il JOB della PURGE_AM_TABLES NON viene creato in automatico dalo script |
| [`Job monitoring TEMP e UNDO TABLESPACE.sql`](./utilities/Job%20monitoring%20TEMP%20e%20UNDO%20TABLESPACE.sql) | `-` | ALTO | OK | Connettersi con utenza DBA_OP |
| [`mview_refresh_procedure.txt`](./utilities/mview_refresh_procedure.txt) | `-` | ALTO | OK | inserimento tabelle di configurazione |
| [`TEMP_and_UNDO_monitor.sql`](./utilities/TEMP_and_UNDO_monitor.sql) | `-` | ALTO | OK | Monitoraggio capacità tablespace/TEMP/UNDO e prevenzione saturazione. |
