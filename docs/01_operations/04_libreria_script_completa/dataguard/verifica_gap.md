...
> **Scopo**: Controllare se ci sono gap tra il primary e lo standby (archivelog non ancora ricevuti o non ancora applicati).
...
> [!NOTE]
> Un GAP di 1-2 sequence è normale in modalità ASYNC. Un GAP crescente indica un problema di rete o di spazio sullo standby.
