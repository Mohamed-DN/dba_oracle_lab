...
## 🔗 Collegamento
Le partizioni sono trattate anche nella [GUIDA_ATTIVITA_DBA.md](../../../04_governance_learning/03_esami_e_carriera/GUIDA_ATTIVITA_DBA.md) nella sezione batch/manutenzione.
