...
> **Perché i Standby Redo Logs?** Quando i redo log arrivano dal primario, lo standby li scrive prima negli Standby Redo Logs e POI li applica. Senza SRL, usa gli archiv
[oracle@racstby1 ~]$ rman TARGET sys/<password>@RACDB AUXILIARY sys/<password>@RACDB1_STBY
-bash: password: No such file or directory
[oracle@racstby1 ~]$ rman TARGET sys/root_1234@RACDB AUXILIARY sys/<password>@RACDB1_STBY
-bash: password: No such file or directory
[oracle@racstby1 ~]$ rman

ed redo logs, che sono più lenti. La regola "+1" garantisce che ci sia sempre uno SRL disponibile anche durante un log switch.
