...
output_path = r"c:\DBA\dba_oracle_lab\docs\04_governance_learning\02_enterprise_standards\MAA_SCORECARD.md"

content = """# RUNBOOK ENTERPRISE: MAXIMUM AVAILABILITY ARCHITECTURE (MAA) SCORECARD & AUDIT FRAMEWORK
...
print(f"Created MAA Scorecard at {output_path}")
 f.write(content)
